...
public class UpdateContactsRequest<T> extends RcRestRequest<T> {
    private String mRequestBody;


    public UpdateContactsRequest(int requestId, Type responseType, HttpMethod method, String logTag, String requestBody) {
