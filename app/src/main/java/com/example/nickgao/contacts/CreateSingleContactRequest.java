...
public class CreateSingleContactRequest<T> extends RcRestRequest<T> {
    private String mRequestBody;

    public CreateSingleContactRequest(int requestId, Type responseType, HttpMethod method, String logTag) {
        super(requestId, responseType, method, logTag);
    }

    public CreateSingleContactRequest(int requestId, Type responseType, HttpMethod method, String logTag, String requestBody) {
        super(requestId, responseType, method, logTag);
